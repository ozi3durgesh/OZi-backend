...
exports.WarehouseStaffAssignment = exports.WarehouseZone = exports.Warehouse = exports.PackingEvent = exports.LMSShipment = exports.Handover = exports.Rider = exports.Seal = exports.PhotoEvidence = exports.PackingItem = exports.PackingJob = exports.PickingException = exports.PicklistItem = exports.PickingWave = exports.RolePermission = exports.Permission = exports.Role = exports.CouponTranslation = exports.Coupon = exports.Order = exports.User = void 0;
...
const WarehouseZone_1 = __importDefault(require("./WarehouseZone"));
exports.WarehouseZone = WarehouseZone_1.default;
const WarehouseStaffAssignment_1 = __importDefault(require("./WarehouseStaffAssignment"));
exports.WarehouseStaffAssignment = WarehouseStaffAssignment_1.default;
...
Warehouse_1.default.belongsTo(User_1.default, { foreignKey: 'created_by', as: 'CreatedBy' });
Warehouse_1.default.belongsTo(User_1.default, { foreignKey: 'updated_by', as: 'UpdatedBy' });
User_1.default.hasMany(Warehouse_1.default, { foreignKey: 'created_by', as: 'CreatedWarehouses' });
User_1.default.hasMany(Warehouse_1.default, { foreignKey: 'updated_by', as: 'UpdatedWarehouses' });
Warehouse_1.default.hasMany(WarehouseZone_1.default, { foreignKey: 'warehouse_id', as: 'Zones' });
WarehouseZone_1.default.belongsTo(Warehouse_1.default, { foreignKey: 'warehouse_id', as: 'Warehouse' });
Warehouse_1.default.hasMany(WarehouseStaffAssignment_1.default, { foreignKey: 'warehouse_id', as: 'StaffAssignments' });
WarehouseStaffAssignment_1.default.belongsTo(Warehouse_1.default, { foreignKey: 'warehouse_id', as: 'Warehouse' });
WarehouseStaffAssignment_1.default.belongsTo(User_1.default, { foreignKey: 'user_id', as: 'User' });
User_1.default.hasMany(WarehouseStaffAssignment_1.default, { foreignKey: 'user_id', as: 'StaffAssignments' });
