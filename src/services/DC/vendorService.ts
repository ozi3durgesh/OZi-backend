...
export class VendorDCService {
  ...
  static async createVendor(vendorData: any) {
    ...
    const newVendor = await VendorDC.create({
      ...
      agreement: vendorData.agreement,
      panDocument: vendorData.panDocument,
      gstCertificate: vendorData.gstCertificate,
      cancelledCheque: vendorData.cancelledCheque,
      msmeCertificate: vendorData.msmeCertificate,
      bankAccountNumber: vendorData.bankAccountNumber,
      ifscCode: vendorData.ifscCode,
      stockCorrection: vendorData.stockCorrection || false,
      stockCorrectionPercentage: vendorData.stockCorrectionPercentage,
