...
interface DistributionCenterInstance
  extends Model<DistributionCenterAttributes, DistributionCenterCreationAttributes>,
    DistributionCenterAttributes {}

const DistributionCenter = sequelize.define<DistributionCenterInstance>('DistributionCenter', {
  id: {
  ...
  type: {
    type: DataTypes.ENUM('MAIN', 'REGIONAL', 'LOCAL'),
    allowNull: false,
