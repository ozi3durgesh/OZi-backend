...
ProductMaster.hasMany(ReturnRequestItem, { foreignKey: 'item_id', sourceKey: 'id', as: 'returnRequestItems' });
ReturnRequestItem.belongsTo(ProductMaster, { foreignKey: 'item_id', targetKey: 'id', as: 'product' });
