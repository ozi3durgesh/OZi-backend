...
ParentProductMasterDC.init(
  {
    ...
    fc_id: { type: DataTypes.INTEGER, allowNull: true, references: { model: 'FulfillmentCenters', key: 'id' } },
    dc_id: { type: DataTypes.INTEGER, allowNull: true, references: { model: 'DistributionCenters', key: 'id' } },
  },
  {
    sequelize,
    modelName: 'ParentProductMasterDC',
    tableName: 'parent_product_master_dc',
    timestamps: false,
  }
);
